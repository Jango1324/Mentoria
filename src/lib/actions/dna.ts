...
// Server Actions for Learning DNA — called directly from Client Components after quiz completion.
...
export async function saveDNAResult(
  ...
  // Cast to `any` because learning_dna is not in the generated Database type yet.
